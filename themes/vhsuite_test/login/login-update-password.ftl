...
<body>
    ...
    <div class="right-pane">
      <div class="login-form-container">
        <div class="login-sub-form-container">
          ...
          <form id="kc-passwd-update-form" onsubmit="return handleSubmit(event)" method="post" action="${url.loginAction}" class="login-sub-form-container">
            <div>
              <label for="password-new" class="input-label">New Password</label>
              <div style="position: relative">
                <input type="password" value="Test@123" id="password-new" name="password-new" placeholder="Enter new password" class="form-input input-value" />
                <span
            ...
            <div>
              ...
              <div style="position: relative">
                <input type="password" value="Test@123" id="password-confirm" name="password-confirm" placeholder="Enter confirm password" class="form-input input-value" />
                <span
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    setupPasswordToggle("password-new", "toggleNewPassword", "eyeIconNew");
